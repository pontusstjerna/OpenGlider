...
public class ItemHangGliderBasic extends ItemHangGliderBase {
    ...
    public ItemHangGliderBasic() {
        super(ConfigHandler.basicGliderHorizSpeed, ConfigHandler.basicGliderGlideRatio, ConfigHandler.basicGliderShiftHorizSpeed, ConfigHandler.basicGliderShiftGlideRatio, ConfigHandler.basicGliderWindModifier, ConfigHandler.basicGliderTotalDurability, ModelGlider.MODEL_GLIDER_BASIC_TEXTURE_RL);
